...
namespace dlambda {
  namespace type_traits {
    namespace detail {
      class has_trivial_assign : public boost::static_visitor< bool > {
      public:
        bool operator()( const types::user_defined_type &type_ ) const {
          return type_.trivial_assign;
        }
    ...
    bool has_trivial_assign( const type &type_ ) {
      return apply_visitor( detail::has_trivial_assign(), type_ );
      throw -1;
    }
  }
}
