...
namespace dlambda {
  namespace type_traits {
    namespace detail {
      ...
      class is_nothrow_move_assignable : public boost::static_visitor< bool > {
      public:
        bool operator()( const types::user_defined_type &type_ ) const {
          return type_.nothrow_move_assignable;
        }
    ...
    bool is_nothrw_move_assignable( const type &type_ ) {
      return apply_visitor( detail::is_nothrow_move_assignable(), type_ );
    }
  }
}
