...
namespace dlambda {
  namespace type_traits {
    namespace detail {
      class is_member_function_pointer : public boost::static_visitor< bool > {
      public:
    ...
    bool is_member_function_pointer( const type &type_ ) {
      return apply_visitor( detail::is_member_function_pointer(), type_ );
    }
  }
}
